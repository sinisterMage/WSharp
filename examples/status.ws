...
fn main() i64 {
    ...
    print(render(req, Ok200));
    print(render(req, NotFound404));
    print(render(req, Teapot418));
    print(render(req, Forbidden403));
    print(render(req, ServiceUnavailable503));

    // Resolved at run time, from the type id in the object's header.
    serve(req, NotFound404);
    serve(req, Created201);
    serve(req, BadGateway502);
