...
**Status: draft, awaiting Johnny's ratification.** Nothing here is in force
until it is ratified on the v1.0 campaign thread.
...
- **Which documentation the promise covers.** 1.0's documentation promise covers
  ...
  file — and the language reference and standard-library pages at
  [wsharp.io](https://wsharp.io), whose source is the public repository
  `sinisterMage/wsharp.io`. See the note below.
